...
import { faSearch, faAddressCard, faLayerGroup, faSquarePlus, faFileInvoiceDollar, faDisplay, faDumbbell, faAngleDown, faAngleUp } from '@fortawesome/free-solid-svg-icons'
